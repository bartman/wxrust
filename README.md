...
[![CI](https://github.com/bartman/wxrust/actions/workflows/ci.yml/badge.svg)](https://github.com/bartman/wxrust/actions)
...
<img src="lobster-deadlifting.png" width=100 height=100>
...
`fetch` downloads workouts concurrently (10 dates per GraphQL request, 8 requests in flight) and skips dates that are already cached unless `--force` is used.
